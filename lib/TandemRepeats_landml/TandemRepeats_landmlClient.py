...
class TandemRepeats_landml(object):
    ...
    def tandem_repeats(self, params, context=None):
        """
        ...
        return self._client.call_method(
            'TandemRepeats_landml.tandem_repeats',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('TandemRepeats_landml.status',
