...
module TandemRepeats_landml {
    ...
    */
    funcdef tandem_repeats(TandemRepeatsParams params)
        returns (TandemRepeatsResults output) authentication required;
};
